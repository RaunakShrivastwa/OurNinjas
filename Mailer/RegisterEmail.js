      ...
      console.log(user);
        nodemailer.transpoter.sendMail({
            ...
            <div style="width: 80%; margin: 50px auto; background-color: #fff; padding: 20px; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
              <h2 style="text-align: center; margin-bottom: 20px;">Welcome TO EDUHUB</h2>
          
              <p style="text-align: center; margin-bottom: 20px;">Register And Start Your Learning!!!!!</p>
              ...
              <p style="text-align: center;">Without Varify You Cant Proceed Further</p>
          
              <p style="text-align: center; margin-top: 20px;">Thank you,<br>Your EDUHUB Teams</p>
            </div>
